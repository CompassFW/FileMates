...
* --attachment selector to file multi-document mails one doc at a time ([654d4de](https://github.com/CompassFW/FileMates/commit/654d4def650c3f0fe4cf3bb46d32ce98b9aabd48))
* calendar invitations are never a to-do; trash only after the event ([8c17d1c](https://github.com/CompassFW/FileMates/commit/8c17d1c724032938162056453cf925e42593779c))
...
* close pre-release review findings (--attachment keep-guarantee, --json element guard) ([32dfa41](https://github.com/CompassFW/FileMates/commit/32dfa413c3bd87bdb34d7577fc2d36d15c210c88))
